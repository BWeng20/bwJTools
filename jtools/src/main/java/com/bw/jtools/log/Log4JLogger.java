...
public class Log4JLogger extends Log.LoggerFacade
{
    ...
    public void setLevel( int level )
    {
        ...
        switch ( level )
        {
            case Log.NONE : lv = Level.OFF; break;
            case Log.ERROR:  lv = Level.ERROR; break;
            case Log.WARN:  lv = Level.WARN; break;
            case Log.INFO:  lv = Level.INFO; break;
            case Log.DEBUG: lv = Level.DEBUG; break;
            default:  lv = Level.WARN; break;
        }
